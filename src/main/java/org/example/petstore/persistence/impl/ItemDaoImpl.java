...
public class ItemDaoImpl implements ItemDao {
    ...
    private static final String getItemListByProduct =
    ...
    private static final String getItem =
            "SELECTI.ITEMID,LISTPRICE,UNITCOST,SUPPLIER AS supplierId,I.PRODUCTID AS \"product.productId\",NAME AS \"product.name\",DESCN AS \"product.description\", CATEGORY AS \"product.categoryId\", STATUS, ATTR1 AS attribute1, ATTR2 AS attribute2, ATTR3 AS attribute3, ATTR4 AS attribute4, ATTR5 AS attribute5, QTY AS quantityfrom ITEM I, INVENTORY V, PRODUCT P where P.PRODUCTID = I.PRODUCTID and I.ITEMID = V.ITEMID and I.ITEMID = ?";

    private static final String getInventoryQuantity=
    ...
    public void updateInventoryQuantity(Map<String, Object> param) {
        try{
            ...
            PreparedStatement pStatement = connection.prepareStatement(updateInventoryQuantity);
    ...
    public int getInventoryQuantity(String itemId) {
        ...
        try{
            Connection connection = DBUtil.getConnection();
            PreparedStatement pStatement = connection.prepareStatement(getInventoryQuantity);
    ...
    public List<Item> getItemListByProduct(String productId) {
        ...
        try{
            Connection connection = DBUtil.getConnection();
            PreparedStatement pStatement = connection.prepareStatement(getItemListByProduct);
